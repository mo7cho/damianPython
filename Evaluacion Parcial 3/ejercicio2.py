        ...
        match op:
            ...
            case 3:
                ...
                while True:
                    ...
                    try:
                        devol = int(input("Ingrese la cantidad de libros a devolver: "))
                        ...
                        elif stock + devol > 120:
                            print("No se puede superar la capacidad máxima de la biblioteca.")
            ...
            case 4:
                ...
                print(f"Total de préstamos realizados: {total}")
